    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex-grow p-4 bg-gray-100">
        <div className="grid grid-cols-2 gap-4">
          ...
          <ReservationMainCard navigateProps={Number(localStorage.getItem("partnership")) === 0 ? "/reservation/walk" : "/reservation/walk/partner"} title="산책" description="GPS 경로와 함께 산책 모습 확인" />
