...
function ReservationWalkEditLocate() {
  ...
  return (
    <>
      <Topbar title="위치 선택" backUrl={`/reservation/walk/edit/time/${id}`} sendText="다음" sendFunction={() => (locate.detailAddress === "" ? alertBox("상세 주소를 입력해주세요") : navigate(`/reservation/walk/edit/pet/${id}`))}></Topbar>
...
export default ReservationWalkEditLocate;
