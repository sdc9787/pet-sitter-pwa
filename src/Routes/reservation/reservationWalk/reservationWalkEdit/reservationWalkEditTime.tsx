...
function ReservationWalkEditTime() {
  ...
  return (
    <>
      <Topbar title="시간 선택" backUrl="/reservation/walk" sendText="다음" sendFunction={() => navigate(`/reservation/walk/edit/locate/${id}`)}></Topbar>
...
export default ReservationWalkEditTime;
