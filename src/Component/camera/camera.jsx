  ...
  return (
    <>
      <div className="w-full h-auto relative rounded-lg">
        ...
        <div className="absolute -left-1 -top-1 -bottom-1border-4 rounded-full w-1 border-white "></div>
        ...
        <div className="absolute -left-1 -top-1 -bottom-1 border-4 rounded-full w-6 border-white "></div>
